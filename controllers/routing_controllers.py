...
class LondonRouter(BaseRouter):
    def choose_route(self, env):
        ...
        if veh_id=="bus_0":
            if veh_edge in ["edge_SN_6"]:
                next_route = [veh_edge, 'edge_WE_14', 'edge_WE_15','edge_NS_9','edge_NS_10','edge_EW_5','edge_EW_4','edge_EW_3','edge_SN_7','edge_SN_6']
        elif veh_id=="bus_1":
            if veh_edge in ["edge_NS_8"]:
                next_route = [veh_edge, 'edge_NS_9', 'edge_WE_12','edge_SN_12','edge_EW_16','edge_EW_15','edge_EW_14','edge_SN_5','edge_WE_18','edge_WE_19','edge_NS_8']
...
class TriangleRouter(BaseRouter):
    """A router used to continuously re-route vehicles in minicity network.
    ...
    def choose_route(self, env):
        ...
        if veh_id=="bus_0":
            if veh_edge in ["edge_6"]:
                next_route = [veh_edge, 'edge_9', 'edge_10','edge_11','edge_2','edge_12','edge_13','edge_14','edge_15','edge_29','edge_44','edge_16','edge_17','edge_18','edge_19','edge_20','edge_3','edge_4','edge_5','edge_6']

        if veh_edge in ["edge_21"]:
            next_route=["edge_21",'edge_22','edge_23']
