...
class BristolTriangleClosed(Network):
    ...
    def specify_nodes(self, net_params):
        ...
        nodes = [
                 ...
                 {'id': 'NE_1a', 'x': 413.03, 'y': 485.28},            #Added to make system closed
    ...
    def specify_edges(self, net_params):
        ...
        edges = [
                ...
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_34b', 'from': 'NS_C2', 'to': 'NS_C3', 'length': None,
                'numLanes': 2, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_39', 'from': 'SN_C1', 'to': 'NE_1a', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_40', 'from': 'NE_1a', 'to': 'NE_1', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_41', 'from': 'SN_4', 'to': 'NE_1', 'length': None,
                'numLanes': 2, 'type': 'edgeType', 'spreadType': 'center', 'shape':'350.78,455.29'},
                {'id': 'edge_42', 'from': 'NS_C3', 'to': 'SE_1c', 'length': None,
                'numLanes': 2, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_43', 'from': 'SE_1c', 'to': 'SN_1', 'length': None,
                'numLanes': 2, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_44', 'from': 'NE_6', 'to': 'SW_1', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_45', 'from': 'SW_1', 'to': 'NE_6', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_46', 'from': 'NE_6', 'to': 'NE_5', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center'},
                {'id': 'edge_47', 'from': 'SW_1', 'to': 'EW_C1', 'length': None,
                'numLanes': 1, 'type': 'edgeType', 'spreadType': 'center','shape':'632.53,215.70'},
    ...
    def specify_connections(self, net_params):
        conn=[]
        num_lanes = 2
        edges_from_b = ['edge_2','edge_11','edge_17','edge_20','edge_21','edge_23','edge_12']          #Add edges here if they have equal lane mapping
        edges_to_b = ['edge_12','edge_25','edge_18','edge_3','edge_22','edge_24','edge_21']
        ...
        edges_from_a = ['edge_2','edge_2','edge_2','edge_11','edge_14','edge_24','edge_24','edge_37','edge_44','edge_43','edge_22','edge_12','edge_6','edge_6']         #Add edges here if lanes 0 are connected
        edges_to_a = ['edge_3','edge_33','edge_30', 'edge_2','edge_15','edge_45','edge_47','edge_38','edge_16','edge_8','edge_23','edge_13','edge_9','edge_7']
        ...
        edges_from_c = ['edge_2','edge_17','edge_43','edge_12','edge_6','edge_6','edge_2','edge_2','edge_2']         #Add edges here if lanes 1 and 0 are connected
        edges_to_c = ['edge_30','edge_37','edge_8','edge_13','edge_9','edge_7','edge_3','edge_33','edge_30']
        ...
        edges_from_d = ["edge_32",'edge_6']         #Add edges here if lanes 0 and 1 are connected
        edges_to_d = ["edge_3",'edge_9']
        ...
        edges_from_e = ["edge_24",'edge_22','edge_6']         #Add edges here if lanes 0 and 1 are connected
        edges_to_e = ["edge_16",'edge_23','edge_9']
        for e_from, e_to in zip(edges_from_e, edges_to_e):
            conn += [{
                'from': e_from,
                'to': e_to,
                'fromLane': 1,
